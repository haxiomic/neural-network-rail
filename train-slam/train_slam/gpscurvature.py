...
def get_offset_coordinate(latitude, longitude, dx, dy):
...
def get_initial_bearing(start_latitude, start_longitude, end_latitude, end_longitude):
    """
    Uses the Haversine formula with the mean Earth r_earth to calculate the initial bearing from point 1, accurate enough for
    smaller distances.
